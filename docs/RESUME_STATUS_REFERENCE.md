...
### `normalized`
Comments removed, whitespace standardized, ready for parsing. Set by `normalize_resume()` orchestration function (called via `scripts/normalize_latex.py normalize`).
